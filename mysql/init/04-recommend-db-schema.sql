...
CREATE TABLE IF NOT EXISTS recommend_merchant_keyword_override (
  ...
  override_category ENUM('FOOD','CAFE','GROCERY','CVS','SHOPPING','AUTO','TRANSIT','TAXI','HEALTH','PHARMACY','BEAUTY','LEISURE','FITNESS','EDU','TELECOM','UTILITY','TRAVEL','AIRLINE','INSURANCE','ETC') NOT NULL,
