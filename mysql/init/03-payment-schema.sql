...
CREATE TABLE IF NOT EXISTS payment_orders (
  ...
  payment_intent ENUM('DUTCH_HOST_AUTH_ONLY_PAY', 'DUTCH_HOST_PAY', 'DUTCH_MEMBER_PAY') NULL,
...
CREATE TABLE IF NOT EXISTS payment_card_details (
  ...
  card_status ENUM('PAID', 'CANCEL_REQUESTED', 'CANCELED', 'CANCEL_FAILED') NOT NULL DEFAULT 'PAID',
...
CREATE TABLE IF NOT EXISTS dutch_pay_sessions (
  ...
  status ENUM('CREATED','IN_PROGRESS','COMPLETED','TIMEOUT_HANDLED','CANCELED','FAILED') NOT NULL DEFAULT 'CREATED',
...
CREATE TABLE IF NOT EXISTS dutch_pay_participants (
  ...
  payment_id BIGINT NULL,
  status ENUM('INVITED','JOINED','REJECTED','PENDING','PAID','TIMEOUT','HOST_PAID') NOT NULL DEFAULT 'INVITED',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
